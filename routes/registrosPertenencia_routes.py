...
registros_pertenencia_bp = Blueprint('registros_pertenencia', __name__)

# @registros_pertenencia_bp.route('/pertenencia/registrar-pertenencia', methods=['POST'])
# @jwt_required()
...
# @registros_pertenencia_bp.route('/pertenencia/consultar-pertenencia', methods=['POST'])
# @jwt_required()
# @role_required('Personal')
...
# @registros_pertenencia_bp.route('/pertenencia/consultar-pertenencia-busqueda', methods=['POST'])
# @jwt_required()
...
# @registros_pertenencia_bp.route('/pertenencia/registrar-salida-pertenencia', methods=['POST'])
# @jwt_required()
# @role_required('Personal')
...
# @registros_pertenencia_bp.route('/pertenencia/imagen/<filename>')
